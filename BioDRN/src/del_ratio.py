...
# %%Group.router%%_%%Scenario.endTime%%
...
for folder in folders:
	...
	for router in routers:
		...
		for time in endTimes:
		    fname = "reports/%s/%s_%s_MessageStatsReport.txt" % (folder, router, time)
		    ...
		    energyfname = "reports/%s/%s_%s_EnergyLevelReport.txt" % (folder, router, time)
		    if os.path.isfile(fname):
