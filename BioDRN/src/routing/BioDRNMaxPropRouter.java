 ...
 */
public class BioDRNMaxPropRouter extends ActiveRouter {
	 ...
	 */
	public BioDRNMaxPropRouter(Settings settings) {
		super(settings);
	 ...
	 */
	protected BioDRNMaxPropRouter(BioDRNMaxPropRouter r) {
		super(r);
		this.alpha = r.alpha;
	...
	public void changedConnection(Connection con) {
		if (con.isUp()) { // new connection
			...
			if (con.isInitiator(getHost())) {
				...
				assert mRouter instanceof BioDRNMaxPropRouter : "MaxProp only works "+ 
				" with other routers of same type";
				BioDRNMaxPropRouter otherRouter = (BioDRNMaxPropRouter)mRouter;
	...
	private Tuple<Message, Connection> tryOtherMessages() {
		...
		for (Connection con : getConnections()) {
			...
			BioDRNMaxPropRouter othRouter = (BioDRNMaxPropRouter)other.getRouter();
	...
	private class MaxPropComparator implements Comparator<Message> {
		 ...
		 * {@link BioDRNMaxPropRouter#getCost(DTNHost, DTNHost)}) is first. 
		 */
	...
	public MessageRouter replicate() {
		BioDRNMaxPropRouter r = new BioDRNMaxPropRouter(this);
		return r;
	}
